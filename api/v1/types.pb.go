...
const file_api_v1_types_proto_rawDesc = "" +
	...
	"$WORKFLOW_EXECUTION_STATUS_TERMINATED\x10\x04*\x98\x01\n" +
	...
	"\x1aCOMMAND_TYPE_FAIL_WORKFLOW\x10\x03B*Z(github.com/asakaida/dandori/api/v1;apiv1b\x06proto3"
...
var file_api_v1_types_proto_goTypes = []any{
	...
	(*ActivityFailure)(nil),                // 9: dandori.api.v1.ActivityFailure
...
var file_api_v1_types_proto_depIdxs = []int32{
	...
	10, // 1: dandori.api.v1.WorkflowExecution.created_at:type_name -> google.protobuf.Timestamp
	10, // 2: dandori.api.v1.WorkflowExecution.updated_at:type_name -> google.protobuf.Timestamp
	10, // 3: dandori.api.v1.WorkflowExecution.closed_at:type_name -> google.protobuf.Timestamp
	10, // 4: dandori.api.v1.HistoryEvent.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 5: dandori.api.v1.Command.type:type_name -> dandori.api.v1.CommandType
	11, // 6: dandori.api.v1.ScheduleActivityTaskAttributes.start_to_close_timeout:type_name -> google.protobuf.Duration
	8,  // 7: dandori.api.v1.ScheduleActivityTaskAttributes.retry_policy:type_name -> dandori.api.v1.RetryPolicy
	11, // 8: dandori.api.v1.RetryPolicy.initial_interval:type_name -> google.protobuf.Duration
	11, // 9: dandori.api.v1.RetryPolicy.max_interval:type_name -> google.protobuf.Duration
